...
public class ShieldKnockBackAttack : MonsterSkill
{
    ...
    // 공격 애니메이션 피격 이벤트
    public void ShieldAnimationEvent()
    {
        ...
        foreach (Collider hit in hits)
        {
            ...
            if (angleToTarget < hitAngle)
            {
                ...
                hit.GetComponent<PlayerMovement>().KnockBack(directionToTarget, knockbackTime, knockbackForce);
            }
        }
    }
}